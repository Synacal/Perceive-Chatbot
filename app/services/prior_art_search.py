...
from app.utils.prior_art_search_helpers import vectorize_description, query_pinecone_index, generate_analysis
...
async def search_patents(data: PatentAnalysis):
    ...
    for match in query_results['matches']:
        ...
        results.append(PatentResult(id=patent_id, title=title, abstract=abstract, content=content))
    return results